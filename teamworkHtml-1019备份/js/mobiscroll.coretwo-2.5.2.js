        ...
        that.show = function (prevAnim) {
            ...
            if (s.display != 'inline') {
                ...
                that.tap($('.dwb-s span', dw), function () {
                    if (that.hide(false, 'set') !== false) {//点击确定按钮
				...
				//ZQ 选择时间
                        $(".Incident_alert_time span").css({"width":"3rem"});
						$(".Incident_alert_time span").html("时间：");
						$(".Incident_alert_time .Creat_time_inputtwo").css({"width":"74%"});
                    }
                });
                ...
                $('input,select,button').each(function () {// 弹窗出现事件
