...
//点击完成
$(".Index_list_con_alert p").click(function(e){
	e.stopPropagation();
});
//周期行动标记未完成
$(".Index_list_con_alertseven").click(function(){
	$(".event_summary").show();
	$(".Index_accept").show();
});
//标记全部
...
$(".Index_project_list_from i").click(function(){
	$(".event_summary").show();
	$(".Index_overtime").show();
})
//点击弹窗取消按钮
...
$(".Index_list_con_btm").on("click",".Index_list_con_btn",function(e){
	e.stopPropagation();
	$(".Index_list_con_alert").hide();
	$(this).parents(".Index_list_con_list").find(".Index_list_con_alert").show();
});
//离焦事件
$("body").click(function(){
	$(".Index_list_con_alert").hide();
